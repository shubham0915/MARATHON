...
# def _load_fallback():
#     """Try one embed call to verify fallback is reachable. Returns model or None."""
#     try:
#         model = SentenceTransformer("all-mpnet-base-v2")
#         model.embed_query("probe")
#         logfire.info("Fallback embeddings ready (all-mpnet-base-v2, 768-dim).")
#         return model
#     except Exception as e:
#         logfire.warning(f"Fallback probe failed: {e}. Will use no embeddings.")
#         return None
